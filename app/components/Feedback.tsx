            ...
            >
                <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center z-50">
                    <div className="w-[600px] h-[350px] bg-white rounded-xl">
                        {/* Header section */}
                        <div className="bg-[#FD9F10] rounded-t-lg text-white p-6 mb-4 flex justify-between items-center">
                        ...
                        {/* Feedback Details */}
                        <div className='p-8 pt-2 font-poppins text-[#344054] mt-2'>
                            <div className="flex flex-row items-center justify-between">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="mt-2 text-sm">
                                        {selectedFeedback ? new Date(selectedFeedback.createdAt).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' }) : ''}
                                    </p>
                                </div>
                            </div>
